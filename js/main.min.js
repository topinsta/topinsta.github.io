...
that.videoPlaying=null)}},300)})},Application.prototype.videoEvents=function(){for(var that=this,playEvent=function(element){element.addEventListener("play",function(){that.videoPlaying&&that.videoPlaying.pause&&that.videoPlaying.pause(),that.videoPlaying=this}),element.addEventListener("pause",function(){that.videoPlaying=null})},i=0;i<this.videos.length;i++){var id=this.videos.shift(),element=document.getElementById(id);playEvent(element)}},window.Application=new Application}(window);
...
var TestFire = function() {
	var data = {
		...
		message: 'Lorem ipsum dlor met lorem ipsum dolor met.'
	};
	var rootRef = new Firebase('https://topsinta.firebaseio.com/web/data');
